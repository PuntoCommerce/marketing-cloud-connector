...
/**
 * Sends an email that a profile has been updated by adding or modifying a payment instrument
 */
function sendAccountUpdatedEmail() {
	// Send email about updating the account
